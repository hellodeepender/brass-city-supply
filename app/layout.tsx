    ...
    <html lang="en">
      <body className="flex flex-col min-h-screen bg-white">
        ...
        <a
          ...
          className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20bd5a] text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
        >
